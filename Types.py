...
class Vertex:
    def __init__(self, x=None, y=None, **extra_v):
        ...
        if x is None and y is None or extra_v:
            raise BadBoundingException([x, y, extra_v])
        self._x = x
        self._y = y
...
class StudentIDField(TextField):
    ...
    def __init__(self, data):
        if isinstance(data, TextField):
            super().__init__(data.raw, "Student ID")
        else:
...
class FirstNameField(TextField):
    ...
    def __init__(self, data):
        if isinstance(data, TextField):
            super().__init__(data.raw, "First Name")
        else:
...
class LastNameField(TextField):
    ...
    def __init__(self, data):
        if isinstance(data, TextField):
            super().__init__(data.raw, "Last Name")
        else:
